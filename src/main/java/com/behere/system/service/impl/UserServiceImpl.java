...
public class UserServiceImpl implements UserService {
	...
	public int save(UserDO user) {
		user.setUserId(IdWorker.generateSnowFlakeId());
		...
		for (String roleId : roles) {
			...
			ur.setId(IdWorker.generateSnowFlakeId());
			ur.setUserId(userId);
			ur.setRoleId(roleId);
//			list.add(ur);
...
//		}
    ...
    public Map<String, Object> updatePersonalImg(MultipartFile file, String avatar_data, String userId) throws Exception {
		...
		FileDO sysFile = new FileDO(String.valueOf(FileType.fileType(fileName)), "/files/" + fileName, DateUtils.formatNowDate());
		//获取图片后缀
