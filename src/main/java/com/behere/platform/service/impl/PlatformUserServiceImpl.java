...
public class PlatformUserServiceImpl implements PlatformUserService {
    ...
    @Override
    public int updateUserAuthInformation(int status, String id) {
        return platformUserDao.updateUserAuthInformation(status, id);
    }

    @Override
    @Transactional(rollbackFor = RuntimeException.class)
    public int dealSuccessUserAuth(int status, String authId, String userId) {
        try {
    ...
    @Override
    public int updateUserDeleted(int deleted, String userId) {
