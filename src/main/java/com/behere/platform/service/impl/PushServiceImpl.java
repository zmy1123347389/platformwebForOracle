...
public class PushServiceImpl implements PushService, Job {
    ...
    public int savePushInformation(PushDO pushDO) {
    	pushDO.setId(IdWorker.generateSnowFlakeId());
    ...
    @Override
    public void savePushUser(String pushId, String[] ids) {
    ...
    public void execute(JobExecutionContext context) throws JobExecutionException {
        ...
        PushDO pushDO = queryPushInformationById(String.valueOf(jobName));
    ...
    @Override
    public void sendBroadcast(int type, String[] ids, String title, String content) {
    ...
    @Override
    public PushDO queryPushInformationById(String id) {
        return pushDao.queryPushInformationById(id);
    }

    @Override
    public String[] queryPushUserByPushInformationId(String pushId) {
