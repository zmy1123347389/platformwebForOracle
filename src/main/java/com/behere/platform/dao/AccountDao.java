...
public interface AccountDao {
     ...
     * @return
     */
    int updateWithdrawalStatus(@Param("id") String id, @Param("type") int type);
     ...
     * @return
     */
    User queryUserByIdForUpdate(@Param("userId") String userId);
     ...
     * @return
     */
    int addFlower(@Param("flower") int flower, @Param("userId") String userId);
     ...
     * @return
     */
    WithdrawalCash queryWithdrawalById(@Param("id") String id);
